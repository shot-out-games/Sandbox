...
namespace DungeonArchitect.Editors.LaunchPad
{
    public class LaunchPadWindow : EditorWindow
    {
        ...
        {
            string assetStoreURL = "http://u3d.as/nAL";
        ...
        IWidget BuildCategoriesListView()
        {
            ...
            var dataSource = new LaunchPadCategoryDataSource();
            dataSource.SetItems(categories.ToArray());
            ...
            categoryListView.Bind(dataSource);
