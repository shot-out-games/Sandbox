...
public class RestrictComponent : MonoBehaviour, IConvertGameObjectToEntity
{
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        //
        // For example,
           dstManager.AddComponentData(entity, new InputRestrictComponent() { lt = false, v = false, h = false});
