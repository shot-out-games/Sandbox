...
public struct StartGameMenuComponent : IComponentData
{

}


public class StartGameMenuGroup : MonoBehaviour, IConvertGameObjectToEntity
{
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        dstManager.AddComponentData(entity, new StartGameMenuComponent()
        {
