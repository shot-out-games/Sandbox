...
public class NonPlayerCharacterGeneric : MonoBehaviour, IConvertGameObjectToEntity
{
    [HideInInspector]
    ...
    public void AnimationMovement()
    {
        ...
        float speed = velz * manager.GetComponentData<NpcMovementComponent>(entity).speedMultiple;

        //anim.SetFloat("velx", velx);
        //Debug.Log("sp " + speed);
        anim.SetFloat("Speed", speed, .06f, Time.deltaTime);
