    ...
    public abstract class GrammarNodeRendererBase : GraphNodeRenderer
    {
        ...
        void DrawPin(UIRenderer renderer, GraphRendererContext rendererContext, GraphPin pin, GraphCamera camera, Color nodeColor)
        {
            ...
            if (pin.Node != null && pin.Node.Selected)
            {
                ...
                renderer.backgroundColor = GrammarNodeEditorConstants.FOCUS_HIGHLITE_COLOR;
                renderer.Box(focusboundsScreen, "");
                //WidgetUtils.DrawWidgetFocusHighlight(focusboundsScreen, GrammarNodeEditorConstants.FOCUS_HIGHLITE_COLOR);
            }

            renderer.backgroundColor = GetPinColor(pin, nodeColor);
            renderer.Box(pinBounds, "");
        ...
        void DrawNodeBody(UIRenderer renderer, GraphRendererContext rendererContext, GraphNode node, GraphCamera camera)
        {
            ...
            renderer.backgroundColor = nodeColor;
            renderer.Box(boxBounds, "");
