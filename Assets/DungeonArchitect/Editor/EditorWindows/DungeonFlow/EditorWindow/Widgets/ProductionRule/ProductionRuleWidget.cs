...
namespace DungeonArchitect.Editors.DungeonFlow
{
    ...
    public class ProductionRuleWidget : WidgetBase
    {
        ...
        public void Init(DungeonFlowAsset flowAsset, GrammarProductionRule productionRule, UISystem uiSystem)
        {
            ...
            if (productionRule != null)
            {
                ...
                LHSGraphPanel = new GraphPanel<DungeonFlowGrammarGraphEditor>(LHSGraph, flowAsset, uiSystem);
        ...
        {
            var graphPanels = WidgetUtils.GetWidgetsOfType<GraphPanel<DungeonFlowGrammarGraphEditor>>(widget);
        ...
        ProductionRuleWidgetRHSState AddRHSState(WeightedGrammarGraph RHSGraph, UISystem uiSystem)
        {
            ...
            var RHSGraphPanel = new GraphPanel<DungeonFlowGrammarGraphEditor>(RHSGraph.graph, flowAsset, uiSystem);
