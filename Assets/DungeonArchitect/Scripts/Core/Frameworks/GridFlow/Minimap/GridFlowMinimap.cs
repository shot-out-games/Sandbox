...
namespace DungeonArchitect.Builders.GridFlow
{
    ...
    public class GridFlowMinimap : DungeonMiniMap
    {
        ...
        GridFlowTilemapRenderResources resources;
        ...
        {
            resources = new GridFlowTilemapRenderResources();
        ...
        protected override void UpdateStaticTexture(Texture texture)
        {
            ...
            if (tilemap != null)
            {
                GridFlowTilemapRenderer.Render(rtt, tilemap, tileSize, resources, cell => false);
            }
        }
        ...
        IntVector2[] FogOfWarFilterVisibility(IntVector2[] tiles, IntVector2 player)
        {
            ...
            while (queue.Count > 0)
            {
                ...
                if (cell.CellType == GridFlowTilemapCellType.Wall) continue;
                if (cell.CellType == GridFlowTilemapCellType.Door) continue;
