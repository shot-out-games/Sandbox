...
namespace SharpNav
{
	...
	public class AreaGenerator
	{
		...
		private AreaGenerator(IEnumerable<Triangle3> verts, int triCount, Area defaultArea)
		{
			...
			conditions = new List<Eppy.Tuple<Func<Triangle3, bool>, Area>>();
		}
		...
		{
			conditions.Add(new Eppy.Tuple<Func<Triangle3, bool>, Area>(
				tri =>
				{
		...
		{
			conditions.Add(new Eppy.Tuple<Func<Triangle3, bool>, Area>(func, area));
