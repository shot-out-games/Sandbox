...
namespace FluffyUnderware.DevTools
{
    ...
    public class ThreadPoolWorker<T> : IDisposable
    {
        ...
        public void ParralelFor(Action<T> action, List<T> list)
        {
            ...
            //BUG a bug in iterationPerThread leads to somtimes not using all available threads. For example, if you have 5 items and 4 cores, only 3 cores will be used
