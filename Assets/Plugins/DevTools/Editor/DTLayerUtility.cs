...
namespace FluffyUnderware.DevToolsEditor
{
    ...
    public static class DTLayerUtility
    {
        ...
        public static int AddLayer(string name)
        {
            ...
            using (SerializedObject manager = new SerializedObject(AssetDatabase.LoadAllAssetsAtPath("ProjectSettings/TagManager.asset")[0]))
#else
...
#endif
            {
                tagsProp = manager.FindProperty("tags");
            }
